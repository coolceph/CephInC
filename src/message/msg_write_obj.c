...
int cceph_msg_write_obj_req_free(cceph_msg_write_obj_req** req, int64_t log_id) {
...
int cceph_msg_write_obj_req_send(int fd, cceph_msg_write_obj_req* req, int64_t log_id) {
    assert(log_id, req != NULL);
...
int cceph_msg_write_obj_req_recv(int fd, cceph_msg_write_obj_req* req, int64_t log_id) {
    assert(log_id, req != NULL);
    assert(log_id, req->oid == NULL);
    assert(log_id, req->data == NULL);
...
int cceph_msg_write_obj_ack_free(cceph_msg_write_obj_ack** msg, int64_t log_id) {
...
int cceph_msg_write_obj_ack_recv(int fd, cceph_msg_write_obj_ack* msg, int64_t log_id) {
    assert(log_id, msg != NULL);
    int ret = 0;
...
int cceph_msg_write_obj_ack_send(int fd, cceph_msg_write_obj_ack* msg, int64_t log_id) {
    assert(log_id, msg != NULL);
    int ret = 0;
